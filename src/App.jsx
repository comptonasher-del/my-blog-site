...
const styles = {
  ...
  controls: { maxWidth: "1100px", margin: "0 auto 24px", display: "grid", gridTemplateColumns: "1fr 220px", gap: "12px" },
  layout: { maxWidth: "1100px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 320px", gap: "24px", alignItems: "start" },
